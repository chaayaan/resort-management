...
$sql = "
    SELECT
        ...
        b.actual_check_in_at, b.status AS booking_status,
    ...
    <div id="roomGrid" class="fd-room-grid">
        <?php foreach ($rooms as $r): ?>
            <?php
                ...
                $nextAvailable = '';
                if ($status !== 'available' && $r['check_out_date']) {
                    $nextAvailable = date('d M Y', strtotime($r['check_out_date'])) . ' — 12:00 PM';
                }
            ?>
            <div class="fd-room-card"
                ...
                <?php elseif ($status === 'reserved'): ?>
                    ...
                    <div class="fd-meta">Check-in: <?php echo date('d M Y', strtotime($r['check_in_date'])); ?></div>
                    <div class="fd-spacer"></div>
                    <div class="fd-actions">
